...
def possible_bipartition(dislikes)
  ...
  dislikes.each_index do |i|
    ...
    while !stack.empty?
      ...
      disliked_dogs.each do |dog| # look at the current dog's dislikes [2,3]
        ...
        elsif visited[dog] == visited[curr_dog] # if the current dog is assigned to the same pen as a dog it dislikes
